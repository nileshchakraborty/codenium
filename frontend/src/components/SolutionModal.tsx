...
const SolutionModal: React.FC<SolutionModalProps> = ({ isOpen, onClose, solution, slug, problemStatus, isPage = false }) => {
    ...
    const renderPlaygroundTab = () => (
        <ResizablePanelGroup direction="vertical" className="h-full min-h-[400px]">
            {/* Code Editor */}
            <ResizablePanel defaultSize={75} minSize={20} className="bg-white dark:bg-[#1e1e1e] border-b border-slate-200 dark:border-slate-800 relative group flex flex-col">
            ...
            <ResizablePanel defaultSize={25} minSize={10} className="flex flex-col bg-white dark:bg-[#1e1e1e] text-slate-700 dark:text-slate-300">
                {/* Tabs Header */}
